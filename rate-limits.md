...
When using Claude Opus 4.6, Sonnet 4.5, or Sonnet 4 with the [1M token context window enabled](https://platform.claude.com/docs/en/build-with-claude/context-windows), the following dedicated rate limits apply to requests exceeding 200K tokens.
